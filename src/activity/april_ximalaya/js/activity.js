	...
	new Vue({
		...
		created: function () {
			...
			if (this.userData.isLogin !== 'N') {
				if (this.userData.activityType !== 'XIMALAYA_APRIL') {
		...
		methods: {
			...
			activeStatus: function () {
				...
				$.ajax({
					...
					data: {
						activityTypeStr: 'XIMALAYA_APRIL'
					}
				}).done(function (data) {
				...
				$.ajax({
					url: Helper.basePath + '/activityTurntable/getAprilRewardName.htm',
					type: 'POST',
					dataType: 'json',
					async: false,
					xhrFields: {
			...
			luckyPost: function () {
				...
				var luckdata;
				$.ajax({
						url: Helper.basePath + 'activityTurntable/doAprilLottery.htm',
						type: 'POST',
						dataType: 'json',
						async: false,
						xhrFields: {
